    ...
    <div class="container">
        ...
        <div class="row justify-content-around">
            <div class="col-md-4 p-md-5 text-center">
                <svg class="icon-profile" height="150px" width="150px" version="1.1" id="Capa_1"
                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 60.671 60.671"
                    xml:space="preserve">
                ...
                <h2 class="fs-1 fw-bold text-capitalize">{{ Auth::user()->name }} </h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @if ($restaurant['restaurant_image'])
                                        <img class="img-fluid"
                                            src="{{ asset('storage/' . $restaurant['restaurant_image']) }}" alt="">
                                    @endif

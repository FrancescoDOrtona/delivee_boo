                    ...
                    @foreach ($types as $type)
                        <div class="col-4">
                            <input type="checkbox" name="types[]" id="type-{{ $type->id }}" value="{{ $type->id }}"
                                @checked(in_array($type->id, old('types', []))) onchange="inputValidation('type-{{ $type->id }}')">
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                        <input id="restaurant_address" type="text"
                            ...
                            value="{{ old('restaurant_address') }}" required autocomplete="restaurant_address"
                            oninput="inputValidation('restaurant_address')" onblur="inputValidation('restaurant_address')">
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                        <input id="phone_number" type="text"
                            ...
                            onblur="inputValidation('phone_number')" oninput="inputValidation('phone_number')">
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                        <textarea id="restaurant_description" type="file"
                            ...
                            oninput="inputValidation('restaurant_description')">{{ old('restaurant_description') }}</textarea>

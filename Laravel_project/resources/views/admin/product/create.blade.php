    ...
    <div class="container">
        <div class="row mt-3 mb-3">
            ...
            <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4 row">
                    <label for="image" class="col-md-4 col-form-label text-md-right fw-bold">{{ __('Image') }}</label>
                ...
                <div class="mb-4 row">
                    ...
                    <div class="col-md-6">
                        <textarea id="description" type="file" class="form-control @error('description') is-invalid @enderror"
                            name="description" rows="10" oninput="inputValidation('description')" onblur="inputValidation('description')">{{ old('description') }}</textarea>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>

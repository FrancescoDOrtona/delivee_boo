...
class OrderSeeder extends Seeder
{
    ...
    public function run(Faker $faker): void
    {
        ...
        //     $number_of_products = count($all_products_ids);
        //     $number_of_products_to_select = $faker->numberBetween(1, $number_of_products);

        //     $rdm_products_ids = $faker->randomElements($all_products_ids, $number_of_products_to_select);
        ...
        // solo un ristorante 
      // Recuperiamo l'istanza del ristorante con ID 1
      $current_restaurant = Restaurant::find(1);

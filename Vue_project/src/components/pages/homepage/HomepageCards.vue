<template>
  <div class="container">
    <div class="card-section">
      <div class="card-1 card_sizes">
        <div class="card_layer"></div>
        <div class="card_content">
          <h2>Diventa nostro partner</h2>
          <div class="card_text">
            Raggiungi più clienti con Deliveroo. Gestiamo noi la consegna, così
            tu puoi dedicarti a offrire i migliori piatti e prodotti.
          </div>
          <a
            href="https://restaurants.deliveroo.com/it-it/?utm-campaign=workwithus&amp;utm-medium=organic&amp;utm-source=landingpage"
            class="card_button"
            target="_blank"
            rel="noreferrer"
            >Inizia ora<img
      ...
      <div class="card-2 card_sizes">
        ...
        <div class="card_content">
          ...
          <a
            href="https://deliveroo.it/apply?utm-campaign=ridewithus_lower&amp;utm-medium=organic&amp;utm-source=landingpage"
            class="card_button"
            target="_blank"
            rel="noreferrer"
            >Inizia ora<img
...
.card_sizes {
  ...
  color: #fff;
  box-shadow: 0 6px 20px 0 #0000003d;
}
...
.card_layer {
  ...
  left: 0;
  bottom: 0;
  background: linear-gradient(355.15deg, #2e3333 3.92%, #0000 96.1%);
  opacity: 0.5;
}
